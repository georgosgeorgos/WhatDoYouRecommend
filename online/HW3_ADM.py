...
u_cluster, R_cluster, utility_DataFrame_cluster = computeMatrices(
    CLUSTERS_USERS, CLUSTERS_ITEMS, CLUSTERS_USERS, CLUSTERS_ITEMS, clusters_dict_row, clusters_dict_col
)
    ...
    while True:
        ...
        if r == "y":
            ...
            if r == 0:
                ...
                try:
                    user_number, recommendation = mainContentBased(
                        featuresDict,
                        userDict,
                        isbnDict,
                        users,
                    ...
                    print(
                        "you are a new user(Cold Star!!!). We can only recommend you the most popular books in our database:\n"
                    )
                    for i in mostRated:
                ...
                mainCollaborativeFiltering_CLUSTERING(
                    books_dataFrame,
                    utility_DataFrame,
