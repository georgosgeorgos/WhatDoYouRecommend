...
def CollaborativeFilteringItemItems(
    utility_DataFrame, new_userDict, new_isbnDict, user_number, book_number, score_min, k
):
...
def mainItemItems_clustering(
    books_dataFrame,
    utility_DataFrame,
    utility_DataFrame_cluster,
    R_cluster,
    new_userDict,
    new_isbnDict,
    d_user,
    ...
    if g == 1:
        ...
        try:
            ...
            print(
                "We don't have this book in the utility matrix. We can only recommend the most popular and well rated books in the database:\n"
            )
            for i in mostRated:
    ...
    if user_number != None or book_numbers != None:
        ...
        for book_number in book_numbers.split():
            ...
            score = CollaborativeFilteringItemItems(
                utility_DataFrame, new_userDict, new_isbnDict, user_number, book_number, score_min, k
            )
            if score == None:
            ...
            if score == None:
                ...
                try:
                    print(
                        ...
                        books_dataFrame.loc[book_number]["Book-Title"],
                        " > written by <",
                        books_dataFrame.loc[book_number]["Book-Author"],
                        "> given by user <",
                        user_number,
                        "> is",
                        np.round(score, 3),
...
def CollaborativeFilteringItemUsers(
    utility_DataFrame, new_userDict, new_isbnDict, user_number, book_number, score_min=0, k=3
):
...
def mainItemUsers_clustering(
    ...
    if user_number != None or book_numbers != None:
        ...
        for book_number in book_numbers.split():
            ...
            score = CollaborativeFilteringItemUsers(
                utility_DataFrame, new_userDict, new_isbnDict, user_number, book_number, score_min, k
            )
            if score == None:
            ...
            if score == None:
                ...
                try:
                    print(
                        ...
                        books_dataFrame.loc[str(book_number)]["Book-Title"],
                        " > written by <",
                        books_dataFrame.loc[book_number]["Book-Author"],
                        "> given by user <",
                        user_number,
...
def mainCollaborativeFiltering_CLUSTERING(
    books_dataFrame,
    utility_DataFrame,
    utility_DataFrame_cluster,
    R_cluster,
